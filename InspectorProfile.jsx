...
export default function InspectorProfile() {
  ...
  const isIndia = phone.trim().startsWith("+91");
  ...
  const validatePAN = () => {
    ...
    setPanVerified(panRegex.test(panNumber));
  };
            ...
            {isIndia ? (
              <div className="border border-zinc-200 rounded-xl p-6 bg-white space-y-4">
                ...
                <p className="text-xs text-zinc-500">
                  Verify your PAN number to activate inspector access
                </p>
                ...
                <div className="flex gap-3 max-w-md">
                  ...
                  <button
                    onClick={validatePAN}
                    className="px-6 py-2 bg-black text-white rounded hover:bg-zinc-800 transition text-sm"
                  >
                    Verify
                  </button>
                </div>
