...
import { User, Mail, Phone, CreditCard, FileUp, Pencil, Upload } from "lucide-react";
                    ...
                    <aside className="lg:col-span-4">
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 space-y-6">
                            ...
                            <div className="divide-y divide-gray-200">
                                ...
                                <InfoRow icon={<FileUp size={16} className="text-gray-500" />} label="GST" value={companyData.gstNumber} />
                            </div>
                        </div>
                    </aside>
